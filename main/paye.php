...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-5">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong><a href="#">PAYE REPORT</a></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
...
<table class="table table-bordered  dataTables-example"  align="center" id="tableid" datapagesize="20"   >
         <thead>
          <th colspan="11" >
           ...
           <h4>PAYE Details for <?php echo $period?></h4>            
             </th>
        ...
        <th class="header">Employee Pin </th>
        <th class="header">Basic</th>
        <th class="header">Benefits</th>
        <th class="header">NHIF</th>
        <th class="header">NSSF</th>
        <th class="header">Total Paye</th>
    </thead>
    <tbody>
    <?php 
 ...
 <tfoot>
        ...
        $t=round($tt,0);
        ?>
        <td><strong><font color="red"><?php echo $t ?></font> </strong></td>
    </tfoot>
</table>
</div>
