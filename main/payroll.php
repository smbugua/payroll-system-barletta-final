       ...
       <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-3">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form action="postbenefits.php"  method="post">
                        <div class="row" >
            ...
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    <form action="postdeductions.php"  method="post">
                        <div class="row" >
                                  ...
                                  <div class="col-sm-6">
                                        ...
                                        <button class="btn btn-sm btn-warning pull-right m-t-n-xs" type="submit"><strong>Post</strong></button>
                                    </div>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    <form action="payrollentry.php?period=<?php echo $period ?>"  method="post">
                        <div class="row" >
                                  ...
                                  <div class="col-sm-6">
                                        ...
                                        <button class="btn btn-lg btn-danger  pull-right m-t-n-xs" type="submit"><strong>RUN</strong></button>
                                    </div>
